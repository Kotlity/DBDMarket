...
data class AddProductFieldsState(val name: ValidationStatus, val category: ValidationStatus, val description: ValidationStatus, val price: ValidationStatus, val size: ValidationStatus)
