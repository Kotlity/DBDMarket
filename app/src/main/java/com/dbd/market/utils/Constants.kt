...
object Constants {
    ...
    const val REQUEST_CODE_VOICE_PERMISSION = 3
    const val REQUEST_CODE_VOICE_RECORDING_RESPONSE = 4
    const val REQUEST_CODE_GOOGLE_SIGN_IN = 5

    const val MIN_AMOUNT_OF_IMAGES_TO_SHOW_VIEW_PAGER2_INDICATOR = 2
    const val USER_RECENT_ORDER_LIMIT = 1L
    ...
    const val FIREBASE_FIRESTORE_ADDRESSES_COLLECTION = "Addresses"
    const val FIREBASE_FIRESTORE_ORDERS_COLLECTION = "Orders"

    const val FIREBASE_STORAGE_USERS_IMAGES_PATH = "UsersImages"
    ...
    const val FIREBASE_FIRESTORE_USER_ADDRESSES_ID_FIELD = "id"
    ...
    const val FIREBASE_FIRESTORE_PRODUCTS_NAME_FIELD = "name"
